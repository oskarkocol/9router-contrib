...
export const MODEL_PRICING = {
  ...
  "MiniMax-M2.1":                { input: 0.3,  output: 1.2,  cached: 0.03,  reasoning: 1.2,  cache_creation: 0 },
  "MiniMax-M2.5":                { input: 0.3,  output: 1.2,  cached: 0.03,  reasoning: 1.2,  cache_creation: 0 },
  "MiniMax-M2.7":                { input: 0.3,  output: 1.2,  cached: 0.06,  reasoning: 1.2,  cache_creation: 0 },
  ...
  "minimax-m2.5":                 { input: 0.60,  output: 2.40,  cached: 0.30,  reasoning: 3.60,   cache_creation: 0.60  },
    ...
    "MiniMax-M2":                  { input: 0.3,  output: 1.2,  cached: 0.03,  reasoning: 1.2,  cache_creation: 0 },
  "MiniMax-M2.1-highspeed":      { input: 0.3,  output: 2.4,  cached: 0.03,  reasoning: 2.4,  cache_creation: 0 },
  "MiniMax-M2.5-highspeed":      { input: 0.6,  output: 2.4,  cached: 0.06,  reasoning: 2.4,  cache_creation: 0 },
  "MiniMax-M2.7-highspeed":      { input: 0.6,  output: 2.4,  cached: 0.06,  reasoning: 2.4,  cache_creation: 0 },
// === Grok ===
