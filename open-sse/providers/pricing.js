...
export const MODEL_PRICING = {
  ...
  "glm-5":                          { input: 1, output: 3.2, cached: 0.2, reasoning: 3.2, cache_creation: 0 },
...
export const PATTERN_PRICING = [
  ...
  // --- GLM ---
  { pattern: "glm-5*",          pricing: { input: 1, output: 3.2, cached: 0.2, reasoning: 3.2, cache_creation: 0 } },
  { pattern: "glm-4*",          pricing: { input: 0.6, output: 2.2, cached: 0.11, reasoning: 2.2, cache_creation: 0 } },
  { pattern: "glm-*",           pricing: { input: 1, output: 3.2, cached: 0.2, reasoning: 3.2, cache_creation: 0 } },
