...
export const MODEL_PRICING = {
  ...
  "deepseek-v4-flash":              { input: 0.22, output: 0.66, cached: 0.007, reasoning: 0.66, cache_creation: 0 },
  "deepseek-v4-pro":                { input: 0.66, output: 1.98, cached: 0.022, reasoning: 1.98, cache_creation: 0 },
  // === GLM ===
...
export const PATTERN_PRICING = [
  ...
  { pattern: "deepseek-v*",     pricing: { input: 0.66, output: 1.98, cached: 0.022, reasoning: 1.98, cache_creation: 0 } },
  { pattern: "deepseek-*",      pricing: { input: 0.66, output: 1.98, cached: 0.022, reasoning: 1.98, cache_creation: 0 } },
