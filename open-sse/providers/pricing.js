...
export const MODEL_PRICING = {
  ...
  // === Kimi ===
  "kimi-k2.7-code":                { input: 1.90,  output: 8.00,  cached: 0.38,  reasoning: 8.00,  cache_creation: 0  },
  ...
  "kimi-k2.5":                    { input: 0.60,  output: 3.00,  cached: 0.10,  reasoning: 3.00,  cache_creation: 0  },
...
export const PATTERN_PRICING = [
  ...
  { pattern: "kimi-k2*",        pricing: { input: 0.60,  output: 3.00,  cached: 0.10,  reasoning: 3.00,  cache_creation: 0  } },
