...
export const MODEL_PRICING = {
  ...
  "gpt-5.6-luna": { input: 0.2, output: 1.2, cached: 0.02, reasoning: 1.2, cache_creation: 0.25 },
  "gpt-5.6-terra": { input: 2, output: 12, cached: 0.2, reasoning: 12, cache_creation: 2.5 },
  "gpt-5.6-sol": { input: 2, output: 10, cached: 0.2, reasoning: 10, cache_creation: 2.5 },
  "gpt-6-astra": { input: 10, output: 50, cached: 1, reasoning: 50, cache_creation: 12.5 },
...
export const PROVIDER_PRICING = {
  ...
  tokenrouter: {
    ...
    "openai/gpt-5.6-sol": { input: 2, output: 10, cached: 0.2, cache_creation: 2.5, reasoning: 10 },
...
export const PATTERN_PRICING = [
  ...
  { pattern: "*-codex",         pricing: { input: 1.25, output: 10, cached: 0.125, reasoning: 10, cache_creation: 0 } },
  ...
  { pattern: "gpt-5.6-*",       pricing: { input: 2, output: 12, cached: 0.2, reasoning: 12, cache_creation: 2.5 } },
  { pattern: "gpt-5.3-*",       pricing: { input: 1.75, output: 14, cached: 0.175, reasoning: 14, cache_creation: 0 } },
  { pattern: "gpt-5.2-*",       pricing: { input: 21, output: 168, cached: 0, reasoning: 168, cache_creation: 0 } },
  { pattern: "gpt-5.1-*",       pricing: { input: 1.25, output: 10, cached: 0.125, reasoning: 10, cache_creation: 0 } },
  { pattern: "gpt-5-*",         pricing: { input: 15, output: 120, cached: 0, reasoning: 120, cache_creation: 0 } },
  { pattern: "gpt-5*",          pricing: { input: 1.25, output: 10, cached: 0.125, reasoning: 10, cache_creation: 0 } },
  { pattern: "gpt-4o-*",        pricing: { input: 0.15, output: 0.6, cached: 0.075, reasoning: 0.6, cache_creation: 0 } },
  { pattern: "gpt-4o",          pricing: { input: 2.5, output: 10, cached: 1.25, reasoning: 10, cache_creation: 0 } },
  { pattern: "gpt-4*",          pricing: { input: 30, output: 60, cached: 0, reasoning: 60, cache_creation: 0 } },

  // --- o1 / o-series ---
  { pattern: "o1-*",            pricing: { input: 150, output: 600, cached: 0, reasoning: 600, cache_creation: 0 } },
  { pattern: "o1",              pricing: { input: 15, output: 60, cached: 7.5, reasoning: 60, cache_creation: 0 } },
  { pattern: "o3-*",            pricing: { input: 20, output: 80, cached: 0, reasoning: 80, cache_creation: 0 } },
  { pattern: "o4-*",            pricing: { input: 1.1, output: 4.4, cached: 0.275, reasoning: 4.4, cache_creation: 0 } },
