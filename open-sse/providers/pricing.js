...
export const MODEL_PRICING = {
  ...
  // === Gemini ===
  "gemini-2.0-flash":                { input: 0.1, output: 0.4, cached: 0.025, reasoning: 0.4, cache_creation: 0.08333333 },
  "gemini-2.0-flash-001":            { input: 0.1, output: 0.4, cached: 0.025, reasoning: 0.4, cache_creation: 0.08333333 },
  "gemini-2.0-flash-lite":           { input: 0.075, output: 0.3, cached: 0, reasoning: 0.3, cache_creation: 0 },
  "gemini-2.0-flash-lite-001":       { input: 0.075, output: 0.3, cached: 0, reasoning: 0.3, cache_creation: 0 },
  "gemini-2.5-flash":                { input: 0.3, output: 2.5, cached: 0.03, reasoning: 2.5, cache_creation: 0.08333333 },
  "gemini-2.5-flash-lite":           { input: 0.1, output: 0.4, cached: 0.01, reasoning: 0.4, cache_creation: 0.08333333 },
  "gemini-2.5-pro":                  { input: 1.25, output: 10, cached: 0.125, reasoning: 10, cache_creation: 0.375 },
  "gemini-3-flash-agent":            { input: 0.5, output: 3, cached: 0.03, reasoning: 4.5, cache_creation: 0.5 },
  "gemini-3-flash-preview":          { input: 0.5, output: 3, cached: 0.05, reasoning: 3, cache_creation: 0.08333333 },
  "gemini-3-pro-preview":            { input: 2, output: 12, cached: 0.2, reasoning: 12, cache_creation: 0.375 },
  "gemini-3.1-flash-lite":           { input: 0.25, output: 1.5, cached: 0.025, reasoning: 1.5, cache_creation: 0.08333333 },
  "gemini-3.1-flash-lite-preview":   { input: 0.25, output: 1.5, cached: 0.025, reasoning: 1.5, cache_creation: 0.08333333 },
  "gemini-3.1-pro-high":             { input: 4, output: 18, cached: 0.5, reasoning: 27, cache_creation: 4 },
  "gemini-3.1-pro-low":              { input: 2, output: 12, cached: 0.25, reasoning: 18, cache_creation: 2 },
  "gemini-3.1-pro-preview":          { input: 2, output: 12, cached: 0.2, reasoning: 12, cache_creation: 0.375 },
  "gemini-3.1-pro-preview-customtools": { input: 2, output: 12, cached: 0.2, reasoning: 12, cache_creation: 0.375 },
  "gemini-3.5-flash":                { input: 1.5, output: 9, cached: 0.15, reasoning: 9, cache_creation: 0.08333333 },
  "gemini-3.5-flash-extra-low":      { input: 0.5, output: 3, cached: 0.03, reasoning: 4.5, cache_creation: 0.5 },
  "gemini-3.5-flash-low":            { input: 0.5, output: 3, cached: 0.03, reasoning: 4.5, cache_creation: 0.5 },
  "gemini-flash-latest":             { input: 0.3, output: 2.5, cached: 0.03, reasoning: 2.5, cache_creation: 0.08333333 },
  "gemini-flash-lite-latest":        { input: 0.1, output: 0.4, cached: 0.01, reasoning: 0.4, cache_creation: 0.08333333 },
  "gemini-pro-agent":                { input: 4, output: 18, cached: 0.5, reasoning: 27, cache_creation: 4 },
  "gemini-pro-latest":               { input: 1.25, output: 10, cached: 0.125, reasoning: 10, cache_creation: 0.375 },
// === Qwen ===
...
export const PATTERN_PRICING = [
  ...
  { pattern: "gemini-3.1-flash-lite*", pricing: { input: 0.25, output: 1.50, cached: 0.025, reasoning: 1.50, cache_creation: 0.08333333 } },
  { pattern: "gemini-2.5-flash-lite*", pricing: { input: 0.10, output: 0.40, cached: 0.01, reasoning: 0.40, cache_creation: 0.08333333 } },
  { pattern: "gemini-*-flash-lite", pricing: { input: 0.10, output: 0.40, cached: 0.01, reasoning: 0.40, cache_creation: 0.08333333 } },
  { pattern: "gemini-3.5-flash*", pricing: { input: 1.50, output: 9.00, cached: 0.15, reasoning: 9.00, cache_creation: 0.08333333 } },
  { pattern: "gemini-3-flash*",  pricing: { input: 0.50,  output: 3.00,  cached: 0.05,  reasoning: 3.00,   cache_creation: 0.08333333 } },
  { pattern: "gemini-2.5-flash*", pricing: { input: 0.30, output: 2.50, cached: 0.03, reasoning: 2.50, cache_creation: 0.08333333 } },
  { pattern: "gemini-*-flash",  pricing: { input: 0.30,  output: 2.50,  cached: 0.03,  reasoning: 2.50,   cache_creation: 0.08333333 } },
  { pattern: "gemini-3*pro*",   pricing: { input: 2.00,  output: 12.00, cached: 0.20,  reasoning: 12.00,  cache_creation: 0.375 } },
  { pattern: "gemini-2.5-pro*", pricing: { input: 1.25,  output: 10.00, cached: 0.125, reasoning: 10.00,  cache_creation: 0.375 } },
  { pattern: "gemini-*-pro",    pricing: { input: 1.25,  output: 10.00, cached: 0.125, reasoning: 10.00,  cache_creation: 0.375 } },
  { pattern: "gemini-3-*",      pricing: { input: 0.50,  output: 3.00,  cached: 0.05,  reasoning: 3.00,   cache_creation: 0.08333333 } },
  { pattern: "gemini-2.5-*",    pricing: { input: 0.30,  output: 2.50,  cached: 0.03,  reasoning: 2.50,   cache_creation: 0.08333333 } },
  { pattern: "gemini-*",        pricing: { input: 0.30,  output: 2.50,  cached: 0.03,  reasoning: 2.50,   cache_creation: 0.08333333 } },
