...
export const MODEL_PRICING = {
  ...
  "gemini-2.5-flash":               { input: 0.54,  output: 4.5,  cached: 0.054,  reasoning: 4.5,  cache_creation: 0.15  },
  "gemini-2.5-flash-lite":               { input: 0.18,  output: 0.72,  cached: 0.018,  reasoning: 0.72,  cache_creation: 0.15  },
  "gemini-2.5-pro":               { input: 2.25,  output: 18.00,  cached: 0.225,  reasoning: 18.00,  cache_creation: 0.675  },
  "gemini-3-flash-preview":               { input: 0.9,  output: 5.4,  cached: 0.09,  reasoning: 5.4,  cache_creation: 0.15  },
  "gemini-3-pro-preview":               { input: 3.6,  output: 21.6,  cached: 0.36,  reasoning: 21.6,  cache_creation: 0.675  },
  "gemini-3.1-flash-lite":               { input: 0.45,  output: 2.7,  cached: 0.045,  reasoning: 2.7,  cache_creation: 0.15  },
  "gemini-3.1-flash-lite-image":               { input: 0.25,  output: 1.5,  cached: 0,  reasoning: 1.5,  cache_creation: 0  },
  "gemini-3.1-flash-lite-preview":               { input: 0.45,  output: 2.7,  cached: 0.045,  reasoning: 2.7,  cache_creation: 0.15  },
  "gemini-3.1-pro-preview":               { input: 3.6,  output: 21.6,  cached: 0.36,  reasoning: 21.6,  cache_creation: 0.675  },
  "gemini-3.1-pro-preview-customtools":               { input: 2.00,  output: 12.00,  cached: 0.2,  reasoning: 12.00,  cache_creation: 0.375  },
  "gemini-3.5-flash":               { input: 2.7,  output: 16.2,  cached: 0.27,  reasoning: 16.2,  cache_creation: 0.15  },
  "gemini-flash-latest":               { input: 0.54,  output: 4.5,  cached: 0.054,  reasoning: 4.5,  cache_creation: 0.15  },
  "gemini-flash-lite-latest":               { input: 0.18,  output: 0.72,  cached: 0.018,  reasoning: 0.72,  cache_creation: 0.15  },
  "gemini-pro-latest":               { input: 2.25,  output: 18.00,  cached: 0.225,  reasoning: 18.00,  cache_creation: 0.675  },
  "gemini-3.1-pro-low":               { input: 2.00,  output: 12.00,  cached: 0.25,  reasoning: 18.00,  cache_creation: 2.00  },
  "gemini-3.1-pro-high":               { input: 4.00,  output: 18.00,  cached: 0.5,  reasoning: 27.00,  cache_creation: 4.00  },
  "gemini-pro-agent":               { input: 4.00,  output: 18.00,  cached: 0.5,  reasoning: 27.00,  cache_creation: 4.00  },
  "gemini-3-flash-agent":               { input: 0.5,  output: 3.00,  cached: 0.03,  reasoning: 4.5,  cache_creation: 0.5  },
  "gemini-3.5-flash-low":               { input: 0.5,  output: 3.00,  cached: 0.03,  reasoning: 4.5,  cache_creation: 0.5  },
  "gemini-3.5-flash-extra-low":               { input: 0.5,  output: 3.00,  cached: 0.03,  reasoning: 4.5,  cache_creation: 0.5  },
  "gemini-3-flash":               { input: 0.5,  output: 3.00,  cached: 0.03,  reasoning: 4.5,  cache_creation: 0.5  },
...
export const PATTERN_PRICING = [
  ...
  { pattern: "gemini-*-flash-lite", pricing: { input: 0.18, output: 0.72, cached: 0.018, reasoning: 0.72, cache_creation: 0.15 } },
  { pattern: "gemini-*-flash",  pricing: { input: 0.54,  output: 4.5,  cached: 0.054,  reasoning: 4.5,   cache_creation: 0.15  } },
  { pattern: "gemini-*-pro",    pricing: { input: 2.25,  output: 18.00,  cached: 0.225,  reasoning: 18.00,  cache_creation: 0.675  } },
  { pattern: "gemini-3-*",      pricing: { input: 0.54,  output: 4.5,  cached: 0.054,  reasoning: 4.5,   cache_creation: 0.15  } },
  { pattern: "gemini-2.5-*",    pricing: { input: 0.54,  output: 4.5,  cached: 0.054,  reasoning: 4.5,   cache_creation: 0.15  } },
  { pattern: "gemini-*",        pricing: { input: 0.54,  output: 4.5,  cached: 0.054,  reasoning: 4.5,   cache_creation: 0.15  } },
