...
export const MODEL_PRICING = {
  ...
  // === MiniMax ===
  "MiniMax-M2":                   { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 1.20,   cache_creation: 0.375 },
  "MiniMax-M2.1":                 { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 1.20,   cache_creation: 0.375 },
  "MiniMax-M2.1-highspeed":       { input: 0.30,  output: 2.40,  cached: 0.03,  reasoning: 2.40,   cache_creation: 0.375 },
  ...
  "MiniMax-M3":                   { input: 0.30,  output: 1.20,  cached: 0.06,  reasoning: 1.20,   cache_creation: 0     },
