...
export const MODEL_PRICING = {
  // === Anthropic / Claude ===
  "claude-fable-5":               { input: 10.00,  output: 50.00,  cached: 1.00,  reasoning: 50.00,  cache_creation: 12.5  },
  "claude-haiku-4-5-20251001":               { input: 1.00,  output: 5.00,  cached: 0.1,  reasoning: 5.00,  cache_creation: 1.25  },
  "claude-opus-4-1-20250805":               { input: 15.00,  output: 75.00,  cached: 1.5,  reasoning: 75.00,  cache_creation: 18.75  },
  "claude-opus-4-5-20251101":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 25.00,  cache_creation: 6.25  },
  "claude-opus-4-6":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 25.00,  cache_creation: 6.25  },
  "claude-opus-4-7":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 25.00,  cache_creation: 6.25  },
  "claude-opus-4-8":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 25.00,  cache_creation: 6.25  },
  "claude-sonnet-4-5-20250929":               { input: 3.00,  output: 15.00,  cached: 0.3,  reasoning: 15.00,  cache_creation: 3.75  },
  "claude-sonnet-4-6":               { input: 3.00,  output: 15.00,  cached: 0.3,  reasoning: 15.00,  cache_creation: 3.75  },
  "claude-sonnet-5":               { input: 2.00,  output: 10.00,  cached: 0.2,  reasoning: 10.00,  cache_creation: 2.5  },
  "claude-sonnet-4-20250514":               { input: 3.00,  output: 15.00,  cached: 1.5,  reasoning: 15.00,  cache_creation: 3.00  },
  "claude-opus-4-20250514":               { input: 15.00,  output: 25.00,  cached: 7.5,  reasoning: 112.5,  cache_creation: 15.00  },
  "claude-3-5-sonnet-20241022":               { input: 3.00,  output: 15.00,  cached: 1.5,  reasoning: 15.00,  cache_creation: 3.00  },
  "claude-haiku-4.5":               { input: 0.5,  output: 2.5,  cached: 0.05,  reasoning: 3.75,  cache_creation: 0.5  },
  "claude-opus-4.1":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 37.5,  cache_creation: 5.00  },
  "claude-opus-4.5":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 37.5,  cache_creation: 5.00  },
  "claude-opus-4.6":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 37.5,  cache_creation: 5.00  },
  "claude-sonnet-4":               { input: 3.00,  output: 15.00,  cached: 0.3,  reasoning: 22.5,  cache_creation: 3.00  },
  "claude-sonnet-4.5":               { input: 3.00,  output: 15.00,  cached: 0.3,  reasoning: 22.5,  cache_creation: 3.00  },
  "claude-sonnet-4.6":               { input: 3.00,  output: 15.00,  cached: 0.3,  reasoning: 22.5,  cache_creation: 3.00  },
  "claude-opus-4-5-thinking":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 37.5,  cache_creation: 5.00  },
  "claude-opus-4-6-thinking":               { input: 5.00,  output: 25.00,  cached: 0.5,  reasoning: 37.5,  cache_creation: 5.00  },
