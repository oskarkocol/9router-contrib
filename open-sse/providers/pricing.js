...
export const MODEL_PRICING = {
  ...
  // === MiniMax ===
  "MiniMax-M3":                       { input: 0.30,  output: 1.20,  cached: 0.06,  reasoning: 1.20,  cache_creation: 0.00  },
  "MiniMax-M2.1":                     { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 1.20,  cache_creation: 0.00  },
  "MiniMax-M2.5":                     { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 1.20,  cache_creation: 0.00  },
  "MiniMax-M2.7":                     { input: 0.30,  output: 1.20,  cached: 0.06,  reasoning: 1.20,  cache_creation: 0.00  },
  ...
  "MiniMax-M2":                       { input: 0.255,  output: 1.02,  cached: 0.00,  reasoning: 1.02,  cache_creation: 0.00  },
  "MiniMax-M2.1-highspeed":           { input: 0.30,  output: 2.40,  cached: 0.03,  reasoning: 2.40,  cache_creation: 0.00  },
  "MiniMax-M2.5-highspeed":           { input: 0.60,  output: 2.40,  cached: 0.06,  reasoning: 2.40,  cache_creation: 0.00  },
  "MiniMax-M2.7-highspeed":           { input: 0.60,  output: 2.40,  cached: 0.06,  reasoning: 2.40,  cache_creation: 0.00  },
  // === Grok ===
...
export const PATTERN_PRICING = [
  ...
  // --- MiniMax ---
  { pattern: "MiniMax-*",       pricing: { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 1.20,  cache_creation: 0.00 } },
  { pattern: "minimax-*",       pricing: { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 1.20,  cache_creation: 0.00 } },
