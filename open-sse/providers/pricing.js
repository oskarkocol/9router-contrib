...
export const MODEL_PRICING = {
  ...
  "kimi-k3":                          { input: 3.00,  output: 15.00,  cached: 0.30,  reasoning: 15.00,  cache_creation: 0.00  },
  ...
  "kimi-k2.5":                        { input: 0.60,  output: 3.00,  cached: 0.10,  reasoning: 3.00,  cache_creation: 0.00  },
  "kimi-k2.5-thinking":           { input: 1.80,  output: 7.20,  cached: 0.90,  reasoning: 10.80,  cache_creation: 1.80  },
  "kimi-k2.6":                        { input: 0.95,  output: 4.00,  cached: 0.16,  reasoning: 4.00,  cache_creation: 0.00  },
...
export const PATTERN_PRICING = [
  ...
  { pattern: "kimi-k3*",        pricing: { input: 3.00,  output: 15.00,  cached: 0.30,  reasoning: 15.00,  cache_creation: 0.00 } },
  { pattern: "kimi-k2*",        pricing: { input: 0.60,  output: 3.00,  cached: 0.10,  reasoning: 3.00,  cache_creation: 0.00 } },
