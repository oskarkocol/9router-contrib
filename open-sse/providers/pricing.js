...
export const MODEL_PRICING = {
  ...
  // === GLM ===
  "glm-4.6":                      { input: 0.60,  output: 2.20,  cached: 0.11,  reasoning: 0.00,   cache_creation: 0.00  },
  "glm-4.6v":                     { input: 0.60,  output: 2.20,  cached: 0.11,  reasoning: 0.00,   cache_creation: 0.00  },
  "glm-4.7":                      { input: 0.60,  output: 2.20,  cached: 0.11,  reasoning: 0.00,   cache_creation: 0.00  },
  "glm-5":                        { input: 1.00,  output: 3.20,  cached: 0.20,  reasoning: 0.00,   cache_creation: 0.00  },
  "glm-5.1":                      { input: 1.40,  output: 4.40,  cached: 0.26,  reasoning: 0.00,   cache_creation: 0.00  },
  "glm-5.2":                      { input: 1.40,  output: 4.40,  cached: 0.26,  reasoning: 0.00,   cache_creation: 0.00  },
...
export const PATTERN_PRICING = [
  ...
  // --- GLM ---
  { pattern: "glm-5.1*",        pricing: { input: 1.40,  output: 4.40,  cached: 0.26,  reasoning: 0.00,   cache_creation: 0.00  } },
  { pattern: "glm-5.2*",        pricing: { input: 1.40,  output: 4.40,  cached: 0.26,  reasoning: 0.00,   cache_creation: 0.00  } },
  { pattern: "glm-5-turbo*",    pricing: { input: 1.20,  output: 4.00,  cached: 0.24,  reasoning: 0.00,   cache_creation: 0.00  } },
  { pattern: "glm-5*",          pricing: { input: 1.00,  output: 3.20,  cached: 0.20,  reasoning: 0.00,   cache_creation: 0.00  } },
  { pattern: "glm-4*",          pricing: { input: 0.60,  output: 2.20,  cached: 0.11,  reasoning: 0.00,   cache_creation: 0.00  } },
