...
export const PATTERN_PRICING = [
  ...
  { pattern: "kimi-k3*",        pricing: { input: 3, output: 15, cached: 0.3, reasoning: 15, cache_creation: 0 } },
  { pattern: "kimi-k2*",        pricing: { input: 0.6, output: 3, cached: 0.1, reasoning: 3, cache_creation: 0 } },
  { pattern: "kimi-*",          pricing: { input: 3, output: 15, cached: 0.3, reasoning: 15, cache_creation: 0 } },
