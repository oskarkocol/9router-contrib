...
export const MODEL_PRICING = {
  ...
  "gpt-3.5-turbo-1106":              { input: 0.5, output: 1.5, cached: 0, reasoning: 1.5, cache_creation: 0 },
  ...
  "gpt-5.3-codex-high":              { input: 8, output: 32, cached: 4, reasoning: 48, cache_creation: 8 },
  "gpt-5.3-codex-low":               { input: 4, output: 16, cached: 2, reasoning: 24, cache_creation: 4 },
  "gpt-5.3-codex-none":              { input: 3, output: 12, cached: 1.5, reasoning: 18, cache_creation: 3 },
  "gpt-5.3-codex-spark":             { input: 3, output: 12, cached: 0.3, reasoning: 12, cache_creation: 3 },
  "gpt-5.3-codex-xhigh":             { input: 10, output: 40, cached: 5, reasoning: 60, cache_creation: 10 },
