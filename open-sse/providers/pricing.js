...
export const MODEL_PRICING = {
  ...
  "MiniMax-M2.1":                 { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 0.00,   cache_creation: 0.00  },
  "MiniMax-M2.5":                 { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 0.00,   cache_creation: 0.00  },
  "MiniMax-M2.7":                 { input: 0.30,  output: 1.20,  cached: 0.06,  reasoning: 0.00,   cache_creation: 0.00  },
...
export const PATTERN_PRICING = [
  ...
  // --- MiniMax ---
  { pattern: "MiniMax-*",       pricing: { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 0.00,   cache_creation: 0.00  } },
  { pattern: "minimax-*",       pricing: { input: 0.30,  output: 1.20,  cached: 0.03,  reasoning: 0.00,   cache_creation: 0.00  } },
